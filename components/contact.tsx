...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const templateParams = {
      ...
      to_email: "anushkasahariya2004@gmail.com",
    };
    ...
    <section id="contact" className="py-20 bg-gray-100 dark:bg-[#121212]">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:anushkasahariya2004@gmail.com"
                    className="font-medium hover:text-[#FF5252] transition-colors"
                  >
                    anushkasahariya2004@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="https://www.linkedin.com/in/anushka-sharma-0a4847196/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="font-medium hover:text-[#FF5252] transition-colors"
                  >
                    linkedin.com/in/anushka-sharma-0a4847196/
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="https://github.com/Anushka-Sharma-sahariya"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="font-medium hover:text-[#FF5252] transition-colors"
                  >
      ...
      <div className="mt-20 py-6 border-t border-gray-200 dark:border-gray-700">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Made with ❤️ by Anushka Sharma  <br />  © {new Date().getFullYear() } All right reserved.
          </p>
        </div>
      </div>
    </section>
