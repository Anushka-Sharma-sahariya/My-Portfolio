      ...
      content: (
        <div className="space-y-4">
          <div className="p-4 bg-transparent border-2 border-black dark:border-white rounded-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">August 2022 - May 2026</p>
            <p className="mt-2">Bachelor Of Technology (Computer Science) | CGPA: 8.6</p>
            <p className="text-sm">Greater Noida, India</p>
          </div>
          <div className="p-4 bg-transparent border-2 border-black dark:border-white rounded-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
            <h3 className="text-xl font-bold">Rajiv International School, Mathura</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">March 2020 - July 2022</p>
            <p className="mt-2">Science | 10th: 96% — 12th: 89%</p>
      ...
      content: (
        <div className="space-y-4">
           <div className="p-4 bg-transparent border-2 border-black dark:border-white rounded-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">GeeksforGeeks - Bennett University</p>
            <p className="text-xs text-gray-500 dark:text-gray-400">Aug 2024 - Aug 2025</p>
            <h3 className="text-xl font-bold">Vice-Chairperson</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">GeeksforGeeks - Bennett University</p>
            <p className="text-xs text-gray-500 dark:text-gray-400">Aug 2023 - Aug 2024</p>
            <h3 className="text-xl font-bold">Core Designer</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">GeeksforGeeks - Bennett University</p>
            <p className="text-xs text-gray-500 dark:text-gray-400">Aug 2022 - Aug 2023</p>
          </div>
          <div className="p-4 bg-transparent border-2 border-black dark:border-white rounded-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
            <h3 className="text-xl font-bold">Ministry of PR and Branding </h3>
          ...
          <div className="p-4 bg-transparent border-2 border-black dark:border-white rounded-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Zenevia'25</p>
            <p className="text-xs text-gray-500 dark:text-gray-400">2025</p>
          </div>
          <div className="p-4 bg-transparent border-2 border-black dark:border-white rounded-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
            <h3 className="text-xl font-bold">Multimedia Head</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Zenevia'25</p>
